...
from src_fl.utils import permutations

from src_fl.dataloaders.base import default_data_path, ImageResolutionSequenceDataset, ResolutionSequenceDataset, SequenceDataset
...
class SpeechCommands(ResolutionSequenceDataset):
    ...
    def setup(self):
        ...
        from src_fl.dataloaders.datasets.sc import _SpeechCommands
