...
from src_fl.models.nn import LinearActivation, Activation, DropoutNd
from src_fl.models.sequence.block_fft import BlockFFT
from src_fl.models.sequence.long_conv_kernel import LongConvKernel
...
class LongConv(nn.Module):
    def __init__(
        ...
        super().__init__()
        if verbose:
            import src_fl.utils.train
            log = src_fl.utils.train.get_logger(__name__)
    ...
    def forward(self, u, state=None, rate=1.0, lengths=None, **kwargs): # absorbs return_output and transformer src_fl mask
        """
