...
try:
    from src_fl.ops.fftconv import fftconv_ref, fftconv_func
except ImportError:
    fftconv_func = None
...
from src_fl.utils.config import instantiate, auto_assign_attrs
from src_fl.models.nn import Activation
